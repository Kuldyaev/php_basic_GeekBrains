...
<?php foreach ($cart as $item):?>
   <li id="item<?=$item['good_id']?>" data-line=<?=$item['good_id']?> data-id=<?=$item['good_id']?>>
      ...
      <div class="quantityBlock">
         ...
         <div  class="center h70">
            <div class="center h70">
               <img src="images/less.png" alt="delete item" class="qBtns less" data-index=<?=$item['good_id']?>  data-quantity=<?=$item['quantity']?> id="less<?=$item['good_id']?>">
            </div>
            <div class="center h70">
               <p id="quantity<?=$item['good_id']?>"><?=$item['quantity']?></p><p>&nbsp;шт.</p>
            </div>
            <div class="center h70">
               <img src="images/more.png" alt="delete item" class="qBtns more" data-index=<?=$item['good_id']?>>
            </div>   
         </div>
      </div>
      <div class="quantityBlock">
      ...
      <div class="deleteBlock h100 center" >
         <img src="images/delete.png" alt="delete item" class="delete" data-index=<?=$item['good_id']?> data-line=<?=$item['id']?>>
      </div>
   </li>
<?php endforeach;?>
</ul>
